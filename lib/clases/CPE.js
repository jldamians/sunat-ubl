...
class CPE extends Comprobante {
  ...
  // Methods
    ...
    defEmisor(tipoDocumento=null, numeroDocumento=null, razonSocial=null, nombreComercial=null) {
      ...
      this._emisor = new Persona(identidad.codigoCat, numeroDocumento, razonSocial, nombreComercial);
    }

    defFirmante(tipoDocumento=null, numeroDocumento=null, razonSocial=null) {
      const identidad = new TipoDocumentoIdentidad(tipoDocumento);

      this._firmante = new Persona(identidad.codigoCat, numeroDocumento, null, razonSocial);
    }
