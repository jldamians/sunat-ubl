...
class CPERetencion extends CPE {
  ...
  // Methods
     ...
     */
    definirEms(tipoDocumento=null, numeroDocumento=null, razonSocial=null, nombreComercial=null) {
      let identidad;
    ...
    defDireccionEms(codUbigeo=null, codPais=null, direccion=null, urbanizacion=null) {
      ...
      this._emisor.direccion = new Direccion(ubigeo.codigoCat, null, codPais, direccion, urbanizacion);
    }
     ...
     */
    definirPro(tipoDocumento=null, numeroDocumento=null, razonSocial=null, nombreComercial=null) {
      let identidad;
     ...
     * @param {String} urbanizacion, urbanización
     */
    defDireccionPro(codUbigeo=null, codPais=null, direccion=null, urbanizacion=null) {
      let ubigeo;
      ...
      this._receptor.direccion = new Direccion(ubigeo.codigoCat, null, codPais, direccion, urbanizacion);
    }
