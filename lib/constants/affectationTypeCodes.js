...
affectationTypeCodes[exports.GRAVADO_IVAP = '17'] = 'Gravado - IVAP';
...
function getText(affectationTypeCode) {
  ...
  if (checking === true) {
    ...
    throw new Error(`Catálogo Nro. 07, el código de tipo de afectación no existe: ${affectationTypeCode}`);
  }
}
