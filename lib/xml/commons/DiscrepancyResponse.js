    ...
    if (this._tipoComprobante === DOCUMENT_TYPE_CODES.ND) {
      if (this._debitNoteTypeAllowed(this._tipoNota) === true) {
        xml
          ...
          .att('listName', CATALOGS.getCatalogText(CATALOGS.CATALOG_10))
          .att('listURI', CATALOGS.CATALOG_10);
      } else {
      ...
      if (this._creditNoteTypeAllowed(this._tipoNota) === true) {
        xml
          .att('listAgencyName', 'PE:SUNAT')
          .att('listName', CATALOGS.getCatalogText(CATALOGS.CATALOG_09))
          .att('listURI', CATALOGS.CATALOG_09);
      } else {
