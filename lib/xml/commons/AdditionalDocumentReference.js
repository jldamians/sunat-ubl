...
class AdditionalDocumentReference extends Element {
  constructor(tipoDocumento, numeroDocumento, numeroAnticipo, tipoDocEmisor, numDocEmisor) {
    super();

    this._tipoDocumento = tipoDocumento;
    this._numeroDocumento = numeroDocumento;
    this._numeroAnticipo = numeroAnticipo;
  ...
  _DocumentStatusCode() {
    ...
    return DocumentStatusCode
      ...
      .att('listAgencyName', 'PE:SUNAT')
      .txt(this._numeroAnticipo);
  }

  /**
   * Información del emisor del anticipo
   * @return {xmlbuilder} xml element
   */
  _IssuerParty() {
