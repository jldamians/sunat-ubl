...
class AdditionalDocumentReference extends Element {
   ...
   */
  _documentTypeCode() {
    const DocumentTypeCode = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}DocumentTypeCode`);
   ...
   */
  _documentStatusCode() {
    const DocumentStatusCode = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}DocumentStatusCode`);
  ...
  toXMLElement() {
    const additionalDocumentReference = super.create(`${XMLNS.getPrefix(super.prefix.cac)}AdditionalDocumentReference`);
