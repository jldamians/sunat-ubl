...
class AllowanceCharge extends Element {
   ...
   */
  _chargeIndicatorTag() {
    const chargeIndicatorTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}ChargeIndicator`);
  ...
  _allowanceChargeReasonCodeTag() {
    const allowanceChargeReasonCodeTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}AllowanceChargeReasonCode`);
  ...
  _multiplierFactorNumericTag() {
    const multiplierFactorNumericTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}MultiplierFactorNumeric`);
   ...
   */
  _amountTag() {
    const amountTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}Amount`);
   ...
   */
  _baseAmountTag() {
    const baseAmountTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}BaseAmount`);
   ...
   */
  toXMLElement() {
    const allowanceChargeTag = super.create(`${XMLNS.getPrefix(super.prefix.cac)}AllowanceCharge`);
