...
class TaxSubtotal extends Element {
   ...
   */
  _taxableAmount() {
    const taxableAmountTag = super.create(`${super.prefix.cbc}:TaxableAmount`);
   ...
   */
  _taxAmount() {
    const taxAmountTag = super.create(`${super.prefix.cbc}:TaxAmount`);
   ...
   */
  _baseUnitMeasure() {
    const baseUnitMeasureTag = super.create(`${super.prefix.cbc}:BaseUnitMeasure`);
