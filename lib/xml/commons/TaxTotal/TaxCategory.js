...
class TaxCategory extends Element {
   ...
   */
  _percent() {
    const percentTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}Percent`);
   ...
   */
  _perUnitAmount() {
    const perUnitAmountTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}PerUnitAmount`);
  ...
  _taxExemptionReasonCode() {
    const taxExemptionReasonCodeTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}TaxExemptionReasonCode`);
   ...
   */
  _tierRange() {
    const tierRangeTag = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}TierRange`);
  ...
  toXMLElement() {
    const TaxCategory = super.create(`${XMLNS.getPrefix(super.prefix.cac)}TaxCategory`);
