...
class LineGenericTag extends Element {
  ...
  _setIDTag() {
    ...
    tag.xml.txt(this._detalle.nroOrden);
   ...
   */
  _setQuantityTag() {
    const tagName = this._detalle.tagCantidad;
  ...
  _alternativeConditionPriceTag() {
    ...
    tag.xml
      .ele(`${XMLNS.getPrefix(super.prefix.cbc)}PriceAmount`)
        .att('currencyID', this._detalle.codMoneda)
        .txt(this._detalle.imptPrecioUnit);
    ...
    tag.xml
      .ele(`${XMLNS.getPrefix(super.prefix.cbc)}PriceTypeCode`)
        ...
        .txt(this._detalle.tipoPrecioUnit);
  ...
  _setPriceTag() {
    ...
    tag.xml
      .ele(`${XMLNS.getPrefix(super.prefix.cbc)}PriceAmount`)
        .att('currencyID', this._detalle.codMoneda)
        .txt(this._detalle.imptValorUnit);
   ...
   */
  toXMLElement() {
    const tagName = this._detalle.tagDetalle;
