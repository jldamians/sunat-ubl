...
class PrepaidPayment extends Element {
   ...
   */
  _paidAmount() {
    const paidAmount = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}PaidAmount`);
   ...
   */
  _paidDate() {
    const paidDate = super.create(`${XMLNS.getPrefix(super.prefix.cbc)}PaidDate`);
  ...
  toXMLElement() {
    const prepaidPayment = super.create(`${XMLNS.getPrefix(super.prefix.cac)}PrepaidPayment`);
