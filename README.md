...
***`tipoGtin`*** | **_`Tip de estructura GTIN`_** | **`an..14`** | `[X] HBLTD`<br>`[ ] OBGTR` | `[X] HBLTD`<br>`[ ] OBGTR`
...
**_`imptRedondeo`_** | **_`Monto de redondeo del importe total`_** | **`n(12,2)`** | `01, FA`<br>`03, BV`<br>`07, NC`<br>`08, ND`<br>`20, RET`<br>`40, PER` | `01, FA`<br>`03, BV`<br>`07, NC`<br>`08, ND`<br>`20, RET`<br>`40, PER`
